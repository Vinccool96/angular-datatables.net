...
import { IndividualColumnFilteringExample } from './individual-column-filtering-example';
...
describe('IndividualColumnFilteringExample', () => {
  let spectator: Spectator<IndividualColumnFilteringExample>;
  let component: IndividualColumnFilteringExample;

  const createComponent = createComponentFactory({
    component: IndividualColumnFilteringExample,
