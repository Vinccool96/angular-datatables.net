...
import { RowClickExample } from './row-click-example';

describe('RowClickExample', () => {
  let spectator: Spectator<RowClickExample>;
  let component: RowClickExample;

  const createComponent = createComponentFactory({
    component: RowClickExample,
