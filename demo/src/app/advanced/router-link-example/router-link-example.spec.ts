...
import { RouterLinkExample } from './router-link-example';

describe('RouterLinkExample', () => {
  let spectator: Spectator<RouterLinkExample>;
  let component: RouterLinkExample;
  let router: SpyObject<Router>;

  const createComponent = createComponentFactory({
    component: RouterLinkExample,
