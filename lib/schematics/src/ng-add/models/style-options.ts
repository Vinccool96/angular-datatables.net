...
export const ADT_SUPPORTED_STYLES = [
  {
    ...
    packageJson: [{ version: '^2.0.3', name: 'datatables.net-dt', isDev: false }],
    angularJson: [
      {
  ...
  },
  {
    ...
    packageJson: [{ version: '^2.0.3', name: 'datatables.net-bs', isDev: false }],
    angularJson: [
      {
  ...
  },
  {
    ...
    packageJson: [{ version: '^2.0.3', name: 'datatables.net-bs4', isDev: false }],
    angularJson: [
      {
  ...
  },
  {
    ...
    packageJson: [{ version: '^2.0.3', name: 'datatables.net-bs5', isDev: false }],
    angularJson: [
      {
