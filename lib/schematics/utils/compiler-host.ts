...
import { parseTsconfigFile } from './parse-tsconfig';
...
type FakeReadFileFunction = (fileName: string) => string | undefined;

/**
 * Creates a TypeScript program instance for a TypeScript project within the virtual file system tree.
 * @param tree Virtual file system tree that contains the source files.
 * @param tsconfigPath Virtual file system path that resolves to the TypeScript project.
 * @param basePath Base path for the virtual file system tree.
 * @param fakeFileRead Optional file reader function. Can be used to overwrite files in the TypeScript program, or to
 * add in-memory files (e.g. to add global types).
...
export function createMigrationProgram(
  ...
  tsconfigPath: string,
  basePath: string,
  fakeFileRead?: FakeReadFileFunction,
...
/**
 * Creates the compiler host
 * @param tree Virtual file system tree that contains the source files.
 * @param options Overrides of the parsed compiler options.
 * @param basePath Base path for the virtual file system tree.
 * @param fakeRead Optional file reader function. Can be used to overwrite files in the TypeScript program, or to add
 * in-memory files (e.g. to add global types).
 * @returns The host
 */
function createMigrationCompilerHost(
  ...
  host.readFile = (fileName): string | undefined => {
    ...
    if (typeof result !== 'string') {
      // If the relative path resolved to somewhere outside the tree, fall back to
...
/**
 * Checks whether a file can be migrated by our automated migrations.
 * @param basePath Absolute path to the project.
 * @param sourceFile File being checked.
 * @param program Program that includes the source file.
 * @returns If the file can be migrated
 */
export function canMigrateFile(basePath: string, sourceFile: ts.SourceFile, program: ts.Program): boolean {
